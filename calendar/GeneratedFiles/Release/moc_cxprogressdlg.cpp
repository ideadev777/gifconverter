...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CxProgressDlg_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 54, 23)
    ...
    "CxProgressDlg\0onProcessFinished\0\0"
    "QProcess::ExitStatus\0onProcessStandardOutput\0"
};
...
void CxProgressDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CxProgressDlg *_t = static_cast<CxProgressDlg *>(_o);
        switch (_id) {
        case 0: _t->onProcessFinished((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QProcess::ExitStatus(*)>(_a[2]))); break;
        case 1: _t->onProcessStandardOutput(); break;
        default: ;
        }
    }
}

const QMetaObject CxProgressDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CxProgressDlg.data,
      qt_meta_data_CxProgressDlg,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CxProgressDlg.stringdata))
        return static_cast<void*>(const_cast< CxProgressDlg*>(this));
